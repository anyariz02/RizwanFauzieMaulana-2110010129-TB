...
public class AdminMainFrame extends javax.swing.JFrame {
     ...
     public void RoundedFrame(){
       ...
       Connection connection = koneksi.getConnection();
           ...
           String order = " ORDER BY pegawai.id ASC";
            ...
            if(!keyword.equals("")){
                sql = sql + " WHERE nama LIKE ? OR no_telepon LIKE ?";
            }
            sql = sql+order;
       ...
       ResultSet rs;
        ...
        String sql = "SELECT gaji.*, pegawai.jabatan, pegawai.nik, pegawai.nama FROM gaji LEFT JOIN pegawai ON pegawai.id=gaji.id";
           String order = " ORDER BY gaji.id_gaji ASC";
            ...
            if(!keyword.equals("")){
                sql = sql + " WHERE nama LIKE ? OR nik LIKE ?";
            }
            sql = sql+order;
    ...
    public void selectUser(){
        ...
        for (int i=0; i<list.size(); i++){
            ...
            row[4] = list.get(i).getJabatanUser();
            model.addRow(row);
        }
    }
      ...
      public final void resetTable(String keyword){
        ...
        DefaultTableModel model2 = (DefaultTableModel)tbAbsen.getModel();
         ...
         DefaultTableModel model4 = (DefaultTableModel)tbUser.getModel();
        model.setRowCount(0);
    ...
    public void ClearUser(){
            tfIdUser.setText("");
            tfNamaUser.setText("");
            tfUsernameUser.setText("");
            tfPasswordUser.setText("");
            cbJabatanUser.setSelectedIndex(0);
     }
    ...
    private void initComponents() {
        ...
        pmTableUser = new javax.swing.JPopupMenu();
        Ubah4 = new javax.swing.JMenuItem();
        Hapus4 = new javax.swing.JMenuItem();
        ...
        tbGaji.setAutoCreateRowSorter(true);
        ...
        tbAbsen.setAutoCreateRowSorter(true);
        ...
        if (tbAbsen.getColumnModel().getColumnCount() > 0) {
            ...
            tbAbsen.getColumnModel().getColumn(4).setResizable(false);
            tbAbsen.getColumnModel().getColumn(5).setResizable(false);
        }
        ...
        jLabel19.setText("Kelola Data User");
        ...
        btnSimpanUser.setBackground(new java.awt.Color(45, 45, 45));
        btnSimpanUser.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        tbUser.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "Nama", "Username", "Password", "Jabatan"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        tbUser.setSelectionBackground(new java.awt.Color(45, 45, 45));
        ...
        jLabel51.setText("Jabatan");

        cbJabatanUser.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "----", "user", "admin" }));
                            ...
                            .addGroup(pnEditUserLayout.createSequentialGroup()
                                .addGroup(pnEditUserLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnEditUserLayout.createSequentialGroup()
                                        ...
                                        .addGap(71, 71, 71)))
                                .addGroup(pnEditUserLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(tfPasswordUser, javax.swing.GroupLayout.DEFAULT_SIZE, 309, Short.MAX_VALUE)
                                    .addComponent(cbJabatanUser, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                        .addGap(18, 18, 18)
                        .addComponent(btnSimpanUser, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        pnEditUserLayout.setVerticalGroup(
            ...
            .addGroup(pnEditUserLayout.createSequentialGroup()
                ...
                .addGroup(pnEditUserLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel51)
                    .addComponent(cbJabatanUser, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnSimpanUser, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(26, 26, 26)
        ...
        jLabel49.setText("Anda telah mengakses sebagai Admin pada aplikasi ini, silahkan gunakan menu navigasi dikiri untuk mengelola data.");
    ...
    private void btnSimpanUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanUserActionPerformed
        ...
        String jabatanUser = cbJabatanUser.getSelectedItem().toString();
         ...
         try {
                if(status==tambah) {
                    if(namaUser.isEmpty() ||
                      userUser.isEmpty() ||
                      passUser.isEmpty() ||
                      cbJabatanUser.getSelectedIndex() == 0)
                    {
                        JOptionPane.showMessageDialog(null, "Isi Data Terlebih Dahulu");
                    }else{
                        
                    st = con.createStatement();
                    st.execute("INSERT INTO user (nama, username, password, jabatan) VALUES('"+namaUser+"','"+userUser+"','"+passUser+"','"+jabatanUser+"')");
                    JOptionPane.showMessageDialog(null, "Data User Berhasil Ditambahkan");
                    ClearUser();
                    }
         }else{
         String qry = "UPDATE user SET nama = ?, username = ?, password = ? , jabatan = ? WHERE id = ?";
         ps = con.prepareStatement(qry);
                   ps.setString(1, namaUser);
                   ps.setString(2, userUser);
                   ps.setString(3,passUser );
                   ps.setString(4,jabatanUser );
    ...
    private void tbUserMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbUserMouseReleased
         if(evt.getButton() == MouseEvent.BUTTON3){
            if(evt.isPopupTrigger() && tbUser.getSelectedRowCount()!=0){
                pmTableUser.show(evt.getComponent(),evt.getX(),evt.getY());
            }
        }
    ...
    private void Ubah4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Ubah4ActionPerformed
        ...
        TableModel tbp = tbUser.getModel();
        
        tfIdUser.setText(tbp.getValueAt(i, 0).toString());
        tfNamaUser.setText(tbp.getValueAt(i, 1).toString());
        tfUsernameUser.setText(tbp.getValueAt(i, 2).toString());
        tfPasswordUser.setText(tbp.getValueAt(i, 3).toString());
       cbJabatanUser.setSelectedItem(tbp.getValueAt(i, 4).toString());
        ...
        if(pilihan==0){
            if(i>=0){
                try{
                    ...
                    Koneksi koneksi = new Koneksi();
                    Connection con = koneksi.getConnection();
                    String executeQuery = "DELETE FROM user WHERE id = ?";
                    PreparedStatement ps = con.prepareStatement(executeQuery);
                    ps.setString(1, model.getValueAt(i, 0).toString());
                    ps.executeUpdate();
                } catch (SQLException ex){
    ...
    private javax.swing.JMenuItem Hapus4;
    ...
    private javax.swing.JMenuItem Ubah4;
    ...
    private javax.swing.JComboBox<String> cbJabatanUser;
    ...
    private javax.swing.JPopupMenu pmTableUser;
