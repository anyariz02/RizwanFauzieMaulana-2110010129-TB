...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/custom/textfield/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/custom/textfield/eye_hide.png")).getImage();
    ...
    public void setEchoChar(String u2022) {
